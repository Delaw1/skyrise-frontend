...
export class EditDuplex extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    ...
    this.props.propertyData.floors.map((floor) => {
      floor.images.preview = floor.images.url
    })
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-md-4">
                <h2 className="admin-heading clearfix">PROJECTS: 1/2 DUPLEX</h2>
                ...
                <div className="input-space-white">
                  ...
                  <div className="select wht">
                    <select name='owner' value={this.state.owner} onChange={this.handleChange} id="slct">
                ...
                <div className="input-space-white">
                  <div className="row">
                    <div className="col-6 pr-1">
                      ...
                      <div className="select wht">
                        <select name="bedrooms" value={this.state.bedrooms} onChange={this.handleChange} id="slct">
                          <option value="">Select</option>
                    ...
                    <div className="col-6 pl-1">
                      ...
                      <div className="select wht">
                        <select name="bathrooms" value={this.state.bathrooms} onChange={this.handleChange} id="slct">
                          <option value="">Select</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                ...
                <div className="input-space-white">
                  <div className="row">
                    ...
                    <div className="col-6 pl-1">
                      ...
                      <div className="select wht">
                        <select name="levels" value={this.state.levels} onChange={this.handleChange} id="slct">
                          <option value="">Select</option>
                          <option value="1">1</option>
                ...
                <div className="input-space-white">
                  <div className="row">
                    <div className="col-4 pr-1">
                      ...
                      <input type="text" name="lot" value={this.state.lot} onChange={this.handleChange} id="lot" placeholder="Lot Size" />
                    </div>
                ...
                <div className="input-space-white mb-0">
                  ...
                  <div className="select wht">
                    <select name="zone" value={this.state.zone} onChange={this.handleChange} id="slct">
                      <option value="">Select</option>
              ...
              <div className="col-md-4">
                ...
                <div className="input-space">
                  ...
                  <input type="text" name="architect" value={this.state.architect} onChange={this.handleChange} placeholder="Architect" />
                </div>
                <div className="input-space">
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <div className="input-space mb-0">
                  <textarea placeholder="Deposit terms..." id name='deposit_terms' value={this.state.deposit_terms} onChange={this.handleChange} />
                </div>
              </div>
              <div className="col-md-6">
                <h2 className="page-heading ">
                ...
                <div className="input-space  mb-0">
                  <textarea placeholder="Agent commissions..." name='agent_comm' value={this.state.agent_comm} onChange={this.handleChange} />
                </div>
              </div>
            </div>
            ...
            <div className="row">
              {this.state.floors.map((floor, i) => {
                let image_url
                if (floor.images.preview.slice(0, 4) === 'blob') {
                  image_url = floor.images.preview
                } else {
                  image_url = UPLOADURL + "/floor_media/" + floor.images.url
                }
                return <div className="col-md-4">
                  ...
                  <div className="border-img clearfix"><img src={image_url} height='370px' className="img-responsive " /></div>
                </div>
              })}
            </div>
