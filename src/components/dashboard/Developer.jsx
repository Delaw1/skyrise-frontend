                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                ...
                                <div className="input-space ex-top mb-0">
                                    <input type="submit" value={this.props.addDeveloper.status === serviceConstant.CREATE_DEVELOPER_PENDING ? "Loading..." : "Add Developer"} onClick={this.handleSubmit} />
                                </div>
                            </div>
                        </div>
                    </div>
