...
export class AddAttached extends Component {
  ...
  handleEdit = (i, class1, class2, tabs, k = 0) => {
    ...
    if (tabs === 'floors') {
      this.setState(prevState => ({
        current_floor: prevState.floors[i].section[k],
        current_floor_id: i,
  ...
  componentDidMount() {
    // console.log(this.state.promotions.length)
    this.props.clear()
          ...
          <div className="inner-area">
            <div className="container-fluid">
              ...
              <div className="row">
                <div className="col-md-4">
                  ...
                  <div className="input-space">
                    ...
                    <input type="text" name="name" autoComplete="off" onChange={this.handleChange} placeholder="Name" value={this.state.name} />
                  </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <div className="input-space  little-s mb-3">
                            <input type="text" placeholder="Units" disabled={this.state.condo_check ? false : true} name="condos" onChange={this.handleChange} />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <div className="input-space little-s mb-3">
                            <input type="text" placeholder="Units" disabled={this.state.townhouse_check ? false : true} name="townhouse" onChange={this.handleChange} />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <div className="input-space little-s mb-3">
                            <input type="text" placeholder="Units" disabled={this.state.rowhouse_check ? false : true} name="rowhouse" onChange={this.handleChange} />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="col-md-4">
                  ...
                  <div className="input-space">
                    ...
                    <input type="text" list="sales_address" name='sales_address' onChange={this.handleChange} />
              ...
              <div className="h-area mt-ex">
                ...
                <a href="javascript:void(0)" className="close-link open" style={{ cursor: 'pointer' }} onClick={() => this.handleTab('showpanel', 'open', 'amenities')}>Add</a>
              </div>
              ...
              <div className="h-area mt-ex">
                ...
                <a href className="close-link openfloor" style={{ cursor: 'pointer' }} onClick={() => this.handleTab('showfloor', 'openfloor', 'floors')}>Add</a>
              </div>
                        ...
                        return <div className="col-md-4">
                          <div className="plan-box marg-b">
                            <a href="#" data-toggle="modal" data-target="#exampleModal">
                              <div className="border-img"><img src={sect.images.preview} height='370px' className="img-responsive " /></div>
                            </a>
              ...
              <div className="h-area mt-ex">
                ...
                <a href="javascript:void(0)" className="close-link opendoc" style={{ cursor: 'pointer' }} onClick={() => this.handleTab('showdoc', 'opendoc', 'documents')}>Add</a>
              </div>
